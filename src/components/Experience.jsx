            ...
            roles: [
                {
                    ...
                    projects: [
                        ...
                        {
                            id: 'inf-proj-3',
                            title: 'Regulatory Reporting & DQ Automation',
                            impact: 'Real-time Portal Monitoring',
                            tags: ['Unix Shell', 'SQL', 'Workload Automation', 'Web Portal'],
                            deepDive: (
                                <div className="deep-dive-content">
                                    <h4>Overview</h4>
                                    <p>Developed an end-to-end workflow for quarterly regulatory reporting for loan syndication analysis, automating jobs using workload automation tools to increase efficiency by 60%.</p>
                                    
                                    <h4>Core Engineering Responsibilities</h4>
                                    <ul>
                                        <li><strong>Multi-Layered Processing:</strong> Created multi-layered data load processes, including staging, derive, and materialized layers, enhancing data transformation and consumption for downstream systems.</li>
                                        <li><strong>Custom SQL Logic:</strong> Designed and implemented SQL-based data load logic for tables, tailored to client requirements through regular feedback sessions, ensuring a high level of customization and client satisfaction.</li>
                                        <li><strong>Data Quality Framework:</strong> Created Unix scripts for data quality checks with automated email notifications on success and failure, improving data reliability and alert management.</li>
                                        <li><strong>Web Portal Migration:</strong> Led the migration of data quality checks from an existing workflow to a separate application with a web portal, providing real-time status updates (success, failed, warning) and detailed reporting, improving monitoring and transparency.</li>
                                    </ul>
                                </div>
                            )
                        }
            ...
            <div className="container">
                ...
                <div style={{ maxWidth: '960px', margin: '0 auto', position: 'relative' }}>
                    ...
                    {companies.map((company, cIdx) => (
                        <div key={company.id} style={{ marginBottom: '60px' }}>
                            {/* Company Header */}
                            <motion.div
                                        ...
                                        <div style={{
                                            ...
                                            <div>
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
                                                    <span style={{ fontWeight: 500 }}>{role.client}</span>
                                                </div>
                                            </div>
